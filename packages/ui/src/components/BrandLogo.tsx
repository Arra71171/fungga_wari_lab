...
function BrandLogo({ variant = "full", size = "md", className }: BrandLogoProps) {
  ...
  if (variant === "icon") {
    return (
      <span
        ...
        className={cn(
          "inline-flex items-center justify-center rounded-xl border border-border/50 bg-primary/10 p-1.5 text-primary",
          className
        )}
      >
  ...
  return (
    ...
    >
      ...
      <span
        aria-hidden="true"
        className="inline-flex shrink-0 items-center justify-center rounded-xl border border-border/50 bg-primary/10 p-1.5 text-primary"
      >
        <FungaMark size={svgSize} />
      </span>
