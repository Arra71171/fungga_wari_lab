      ...
      >
        ...
        <div className="bg-background flex flex-1 flex-col p-4 justify-center">
          <div className="flex justify-between items-start gap-2">
            ...
            {status && (
              <span className={cn(
                "text-nano uppercase font-mono tracking-widest px-1.5 py-0.5 border shrink-0",
      ...
      <div className="bg-muted relative overflow-hidden aspect-[3/4] w-full shrink-0">
        ...
        {status && (
          <div className="absolute top-2 right-2 z-10">
            <span className={cn(
              "text-nano uppercase font-mono tracking-widest px-2 py-1 flex items-center backdrop-blur-sm shadow-sm border",
