...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to http://localhost:3001/dashboard/overview and observe whether the app redirects to the login page for an anonymous user.
        await page.goto("http://localhost:3001/dashboard/overview")
        
        # -> Fill the email and password fields with the provided credentials, then submit the login form and verify the app redirects back to /dashboard/overview.
