...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email field with the provided username, fill the password field, then submit the form (send Enter).
        ...
        # -> Dismiss the onboarding/tour modal so the dashboard content is fully accessible, then verify KPI widgets, Top Manuscripts, and Recent Activity are displayed.
        frame = context.pages[-1]
        # Click element
