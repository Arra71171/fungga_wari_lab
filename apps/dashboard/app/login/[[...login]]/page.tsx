      ...
      <form onSubmit={handleSubmit} className="mt-4 w-full flex flex-col space-y-4">
        ...
        <div className="space-y-1.5">
          <label
            ...
            className="font-mono text-tight-label text-muted-foreground uppercase tracking-[0.1em]"
          >
            Email Address
          </label>
          <input
        ...
        <button
          ...
          className="w-full rounded-none bg-primary text-primary-foreground font-mono text-tight-label font-black uppercase tracking-[0.22em] h-11 hover:bg-primary/90 active:scale-[0.98] transition-all duration-200 mt-5 disabled:opacity-50 disabled:cursor-not-allowed"
        >
