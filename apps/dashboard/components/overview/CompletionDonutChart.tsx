  ...
  if (!stats) {
    return (
      <div className="flex items-center justify-center h-full min-h-48 border border-dashed border-border bg-secondary/10">
        <p className="font-sans text-xs font-medium tracking-wide text-muted-foreground/50">
          No data yet
        </p>
      </div>
    );
  ...
  return (
    <div className="flex flex-col gap-3 h-full">
      <div className="flex items-center gap-2 px-1">
        ...
        <span className="font-sans text-xs font-medium tracking-wide text-muted-foreground font-bold">
          Completion Rate
        </span>
      </div>
