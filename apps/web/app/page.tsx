    ...
    <div className="relative min-h-screen bg-background text-foreground selection:bg-primary/30 overflow-x-hidden font-sans">
      ...
      >
        <motion.div
          ...
          className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-start relative z-10 xl:pt-8"
        >
          {/* Hero Content */}
          <div className="lg:col-span-7">
            ...
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              className="flex items-center gap-3 mb-8 lg:mb-12 border border-border inline-flex p-2 pr-6 bg-secondary/50"
            >
              <motion.div
            ...
            <div className="mb-8">
              <SplitText
                text="Where stories outlive silence."
                as="h1"
                className="text-5xl sm:text-6xl md:text-7xl lg:text-[5.5rem] font-heading font-black tracking-tighter uppercase leading-[0.9] text-foreground"
                stagger={0.05}
                delay={0.1}
              />
            </div>
            ...
            <motion.div
              ...
              className="py-2 pl-6 border-l-2 border-primary/50 mb-10 max-w-xl"
            >
              <p className="text-lg md:text-xl text-muted-foreground font-sans leading-relaxed tracking-wide">
            ...
            >
              <div className="flex flex-wrap gap-3">
                <MagneticButton strength={0.3}>
                  <Button
                    size="lg"
                    className="h-14 px-8 text-sm font-bold tracking-widest uppercase transition-shadow"
                    asChild
                  >
                    <Link href="/stories">
          ...
          {/* Hero Visual */}
          <div className="lg:col-span-4 lg:col-start-9 relative hidden lg:flex items-start justify-end h-full min-h-[500px]">
            {/* Ambient right margin text */}
            <div className="absolute -right-8 top-1/2 -translate-y-1/2 rotate-90 origin-center hidden xl:block pointer-events-none">
            ...
            <motion.div
              ...
              className="relative w-full aspect-[3/4] bg-background border border-border p-5 md:p-6 flex flex-col justify-between overflow-hidden group transition-all duration-500 hover:border-border-strong hover:shadow-brutal-primary"
            >
              ...
              <div className="flex justify-between items-center z-10 w-full mb-4">
                <div className="flex items-center gap-2">
                  <div className="size-2 bg-status-active rounded-none" />
      ...
      {/* ─── MISSION STATEMENT ────────────────────────────────────────────── */}
      <section className="py-20 bg-background border-b border-border flex items-center justify-center overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
             <h2 className="text-4xl md:text-5xl font-heading font-black uppercase tracking-tighter mb-6 text-foreground">
               What is past is prologue.
             </h2>
             <div className="w-12 h-1 bg-primary mx-auto mb-8" />
             <p className="text-muted-foreground font-mono text-sm md:text-base uppercase tracking-[0.2em] leading-relaxed max-w-2xl mx-auto">
      ...
      <footer className="relative z-10 py-10 px-6 md:px-12 bg-background border-t border-primary">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap justify-center gap-6 text-2xs font-mono text-muted-foreground uppercase tracking-widest font-bold">
            {["Archive", "Sys_Status", "Protocol", "Data Terms"].map((label) => (
